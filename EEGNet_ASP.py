...
class EEGNet_ASP(torch.nn.Module):
    """EEGNet with ASP."""
    ...
    def __init__(
        ...
        self.dense_module.add_module(
            ...
            sb.nnet.linear.Linear(
                input_size=cnn_septemporal_point_kernels*2, # output of conv * 2 because we are getting both mean and std
